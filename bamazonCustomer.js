...
function showProducts(){
	connection.query('SELECT * FROM products', function(err, res){
		...
		for(i=0;i<res.length;i++){
			console.log('Item ID:' + res[i].itemID + ' Product Name: ' + res[i].product_name + ' Price: ' + '$' + res[i].price + '(Quantity left: ' + res[i].stock_quantity + ')')
		}
		console.log('=================================================');
		placeOrder();
		})
